...
@babel/preset-react // react语法支持
react // react库
react-dom // react处理dom
...
+ 引入使用jsx语法报错
```
ERROR in ./src/demo/index.js
Module build failed (from ./node_modules/babel-loader/lib/index.js):
SyntaxError: F:\practice\webpack-react\src\demo\index.js: Support for the experimental syntax 'jsx' isn't currently enabled (7:7):
```
```
在.babelrc文件的presets里面添加@babel/preset-react
```
